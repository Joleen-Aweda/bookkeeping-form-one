# Book-keeping for Secondary Schools: Student’s Book Form One — ADT Bundle Reference
...
**Book-keeping for Secondary Schools: Student’s Book Form One** — This is an English-language Form One secondary school textbook from Tanzania, published by the Tanzania Institute of Education for learners in lower secondary school. It introduces book-keeping in a practical, step-by-step way, covering basic accounting principles, double entry, journals, ledgers, trial balance, and simple financial statements, with many activities, examples, and revision exercises to build competence. The book reflects a curriculum-based, learner-centred approach that connects accounting skills to everyday business life, personal finance, and national contexts such as Tanzanian tax authorities and local trading practices.
...
```
Book-Keeping-Form-1-New-2024-FINAL/
├── adt/                              # THE WEB APP
...
├── Book-Keeping-Form-1-New-2024-FINAL.db                    # SQLite database (pipeline state)
├── Book-Keeping-Form-1-New-2024-FINAL.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval No. 1183 from the United Republic of Tanzania, Ministry of Education, Science and Technology, approving Book-keeping for Secondary Schools Student’s Book Form One as a textbook for Form One under the 2023 syllabus, dated 23 October 2023 and signed by the Commissioner for Education, Dr Lyabwene M. Mtahabwa.",
  "gl001": "account",
  "gl001_def": "a record that shows increases and decreases in one item, such as cash, sales, or wages."
}
```
...
```json
{
  "account": {
    "word": "account",
    "definition": "a record that shows increases and decreases in one item, such as cash, sales, or wages.",
    "variations": ["account","accounts"],
    "emoji": "📒✍️"
  }
}
```
...
```json
{
  "title": "Book-keeping for Secondary Schools: Student’s Book Form One",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-KE"
...
| Original PDF | `Book-Keeping-Form-1-New-2024-FINAL.pdf` |
| Pipeline database | `Book-Keeping-Form-1-New-2024-FINAL.db` (SQLite) |
